...
def write_results_to_file(lemmas_and_proofs, output_file):
    with open(output_file, 'w') as file:
        for lemma, proofs in lemmas_and_proofs.items():
            result = {'lemma-name': lemma, 'proof-shots': proofs}
...
def main():
    ...
    write_results_to_file(lemmas_and_proofs, output_file_path)
